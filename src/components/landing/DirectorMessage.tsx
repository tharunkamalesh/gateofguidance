...
import directorImg from "@/assets/gog1.jpg";
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-lg text-slate-600 leading-relaxed italic font-medium">
                            <p>
                                "Driven by the success of our students, we remain committed to shaping
                                global medical careers and enabling access to world-class education worldwide."
                            </p>
                        </div>
